...
@section('content')
    <div class="section no-pad-bot" id="index-banner">
        <div class="container"><br><br>
            <h1 class="header center green-text">Sistema Administrativo de Obras</h1>
            <h4 class="header center blue-text">Implementação: Engenhe JR</h4>
            <h5 class="header center blue-text">Empresa Multidisciplinar de Engenharia!!!</h5>
         </div>
    </div>
