...
class CreateWorksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('works', function (Blueprint $table) {
            ...
            $table->integer('prefecture_id')->unsigned()->default(1);
            ...
            $table->double('value_free')->default(0);
            ...
            $table->double('repass_value')->default(0);
            ...
            $table->double('spreadsheet_winner')->default(0);
            ...
            $table->double('counterpart_value')->default(0);
